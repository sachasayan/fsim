...
export const Noise = {
  ...
  noise(x, y, z) {
    ...
    h = PERM[AA] & 15; u1 = h < 8 ? x : y; v1 = h < 4 ? y : h === 12 || h === 14 ? x : z;
    let gAA = ((h & 1) === 0 ? u1 : -u1) + ((h & 2) === 0 ? v1 : -v1);

    h = PERM[BA] & 15; u1 = h < 8 ? x - 1 : y; v1 = h < 4 ? y : h === 12 || h === 14 ? x - 1 : z;
    let gBA = ((h & 1) === 0 ? u1 : -u1) + ((h & 2) === 0 ? v1 : -v1);

    h = PERM[AB] & 15; u1 = h < 8 ? x : y - 1; v1 = h < 4 ? y - 1 : h === 12 || h === 14 ? x : z;
    let gAB = ((h & 1) === 0 ? u1 : -u1) + ((h & 2) === 0 ? v1 : -v1);

    h = PERM[BB] & 15; u1 = h < 8 ? x - 1 : y - 1; v1 = h < 4 ? y - 1 : h === 12 || h === 14 ? x - 1 : z;
    let gBB = ((h & 1) === 0 ? u1 : -u1) + ((h & 2) === 0 ? v1 : -v1);

    h = PERM[AA + 1] & 15; u1 = h < 8 ? x : y; v1 = h < 4 ? y : h === 12 || h === 14 ? x : z - 1;
    let gAA1 = ((h & 1) === 0 ? u1 : -u1) + ((h & 2) === 0 ? v1 : -v1);

    h = PERM[BA + 1] & 15; u1 = h < 8 ? x - 1 : y; v1 = h < 4 ? y : h === 12 || h === 14 ? x - 1 : z - 1;
    let gBA1 = ((h & 1) === 0 ? u1 : -u1) + ((h & 2) === 0 ? v1 : -v1);

    h = PERM[AB + 1] & 15; u1 = h < 8 ? x : y - 1; v1 = h < 4 ? y - 1 : h === 12 || h === 14 ? x : z - 1;
    let gAB1 = ((h & 1) === 0 ? u1 : -u1) + ((h & 2) === 0 ? v1 : -v1);

    h = PERM[BB + 1] & 15; u1 = h < 8 ? x - 1 : y - 1; v1 = h < 4 ? y - 1 : h === 12 || h === 14 ? x - 1 : z - 1;
