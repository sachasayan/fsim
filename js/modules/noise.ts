...
export const Noise = {
  ...
  noise(x, y, z) {
    ...
    let g = this.grad;
    let l1 = g(permutation[AA], x, y, z);
    let l2 = g(permutation[BA], x - 1, y, z);
    let m1 = l1 + u * (l2 - l1);

    let l3 = g(permutation[AB], x, y - 1, z);
    let l4 = g(permutation[BB], x - 1, y - 1, z);
    let m2 = l3 + u * (l4 - l3);

    let r1 = m1 + v * (m2 - m1);

    let l5 = g(permutation[AA + 1], x, y, z - 1);
    let l6 = g(permutation[BA + 1], x - 1, y, z - 1);
    let m3 = l5 + u * (l6 - l5);

    let l7 = g(permutation[AB + 1], x, y - 1, z - 1);
    let l8 = g(permutation[BB + 1], x - 1, y - 1, z - 1);
    let m4 = l7 + u * (l8 - l7);
