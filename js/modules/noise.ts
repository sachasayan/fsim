...
// ⚡ Bolt Optimization:
// Extracted fade, lerp, and grad helpers to module-scope to avoid "this.*" context lookup
// overhead during hot loops.
// The fade calculation has also been inlined directly inside noise() to prevent function call overhead.
export const Noise = {
  permutation,
  init(seed = 12345) {
