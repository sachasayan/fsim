    ...
    return (
        ...
        >
            <div className="editor-form-stack">
                <FieldRow label="ID">
                    <Input type="text" readOnly value={getEntityLabel(document, selectedId)} data-testid="field-id" aria-label="ID" />
                </FieldRow>
                ...
                {isAirport(selected) ? (
                    <>
                        <FieldRow label="Template">
                            <Input type="text" readOnly value={selected.template || 'default'} data-testid="field-airport-template" aria-label="Template" />
                        </FieldRow>
